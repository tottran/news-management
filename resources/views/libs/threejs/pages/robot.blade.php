...
@section('content')
	...
	<script type="module">
		...
		import Stats from '{{ asset("jsm/libs/stats.module.js") }}';
		import { MD2Character } from '{{ asset("jsm/misc/MD2Character.js") }}';
		...
		function init() {
			...
			const gt = new THREE.TextureLoader().load( '{{ asset("texture/me.jpg") }}' );
			...
			const config = {
				...
				baseUrl: "{{ asset('models/md2/ratamahatta') }}/",
